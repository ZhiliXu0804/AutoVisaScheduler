...
if __name__ == '__main__':
    ...
    while True:
        ...
        sleepTime = random.randint(3201, 3300) #60 mins to 65 mins
        consecutive = random.randint(30, 40)
        try:
            for i in range(consecutive):
                sleep_consecutive = random.randint(10, 30)
            ...
            log('Sleep for ' + str(sleepTime) + ' secs.')
